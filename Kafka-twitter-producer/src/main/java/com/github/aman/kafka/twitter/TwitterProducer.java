...
public class TwitterProducer {
    ...
    private final String consumerKey = "abc";
    private final String consumerSecret = "abc";
    private final String token = "abc";
    private final String secrets = "abc";
    private final String bootstrapServers = "127.0.0.1:9092";
    Logger logger = LoggerFactory.getLogger(TwitterProducer.class.getName());
    private final String topicName = "twitter-tweets";
            ...
            if(msg!=null){
                ...
                producer.send(record,new Callback(){
                    ...
                    public void onCompletion(RecordMetadata recordMetadata, Exception e) {
                        if(e!=null){
                            logger.info("something bad happen");
                        }
                    }
                });
            }
    ...
    public KafkaProducer<String, String> creatKafkaProducer(){
